...
# Import libraries required for connecting to PostgreSQL (or DB2 if you choose that)
import psycopg2

# Connect to MySQL
connection = mysql.connector.connect(user='root', password='di0WnJhAoVMmIuxdEMQ0JlhL',host='172.21.137.198',database='sales')


# Connect to DB2 or PostgreSql
dsn_hostname = '172.21.44.152'
dsn_user='postgres'        # e.g. "abc12345"
dsn_pwd ='XcFj7zQFWZolC0j5amv942hD'      # e.g. "7dBZ3wWt9XN6$o0J"
